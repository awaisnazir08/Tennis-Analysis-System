...
def draw_player_stats(output_video_frames, player_stats):
    for index, row in player_stats.iterrows():
        ...
        average_player_1_shot_speed = row['player_1_average_shot_speed']
        average_player_2_shot_speed = row['player_2_average_shot_speed']
        average_player_1_speed = row['player_1_average_player_speed']
        average_player_2_speed = row['player_2_average_player_speed']
        ...
        text = f"{average_player_1_shot_speed:.1f} km/h    {average_player_2_shot_speed:.1f} km/h"
        ...
        text = f"{average_player_1_speed:.1f} km/h    {average_player_2_speed:.1f} km/h"
