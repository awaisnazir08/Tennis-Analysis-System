...
def main():
    ...
    for ball_shot_ind in range(len(ball_shot_frames) - 1):
        ...
        player_shot_the_ball_id = min(player_positions.keys(), key=lambda player_id: measure_distance(player_positions[player_id], ball_mini_court_detections[start_frame][1]))
        
        opponent_player_id = 1 if player_shot_the_ball_id == 2 else 2
        ...
        current_player_stats[f'player_{player_shot_the_ball_id}_number_of_shots'] += 1
        current_player_stats[f'player_{player_shot_the_ball_id}_total_shot_speed'] += speed_of_ball_shot
        current_player_stats[f'player_{player_shot_the_ball_id}_last_shot_speed'] = speed_of_ball_shot
